...
function ComedyTvShows() {
  ...
  useEffect(() => {
    ...
    const link = `https://api.themoviedb.org/3/discover/tv?api_key=cc803c8c2a7e8fddea1b3ff64514f0b4&language=en-US&sort_by=popularity.desc&page=${page}&timezone=America%2FNew_York&with_genres=35&include_null_first_air_dates=false&with_watch_monetization_types=flatrate`;
    getTvShows(link, setTvShows);
  }, [setTvShows]);
  return (
    <section className="comedy-tv-shows">
      <h3 className="category">Comedy</h3>
